<template>
    <div class="home">
        <PageTitle icon="fa fa-home" main="Dashboard" sub="Base de conhecimento de desenvolvimento web"></PageTitle>
        <div class="stats">
            ...
            <Stat title="Usuarios" :value="stat.users" icon="fa fa-user" color="#3282cd"></Stat>
        </div>
    </div>
</template>
